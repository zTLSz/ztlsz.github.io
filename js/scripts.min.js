...
$(function() {
      ...
      $(this).mouseenter(function() {
         ...
         clearTimeout(setTimeoutConst2);
           setTimeoutConst = setTimeout(function(){
              $(self).find('.hover__menu').slideDown();
           }, 800);
      }).mouseleave(function() {
        var self2 = $(this);
        clearTimeout(setTimeoutConst);
        setTimeoutConst2 = setTimeout(function(){
              $(self2).find('.hover__menu').slideUp();
           }, 100);
      });
  ...
  function mCalc() {
    ...
    paymentGraf(calcTime, resultToStr);
      ...
      mCalc();
  $('#calc-procent, #calc-price, #calc-depo, #calc-time').on('input', function() {
      mCalc();
  })
    ...
    (function() {
      ...
      {},
      {
        movement: {
          imgWrapper : {
            translation : {x: 5, y: 5, z: 0},
            reverseAnimation : {duration : 400, easing : 'easeOutQuart'}
          },
          caption : {
            translation : {x: 10, y: 10, z: [0,10]},
            reverseAnimation : {duration : 500, easing : 'easeOutQuart'}
          },
          shine : {
